...
#define AP_NAME               ("ExoyLamp")                   // имя WiFi точки доступа, используется как при запросе SSID и пароля WiFi сети роутера, так и при работе в режиме ESP_MODE = 0
...
#define EFF_FIRE              (0U)                          // Огонь
#define EFF_WATERFALL         (1U)                          // Водопад
#define EFF_RAINBOW_VER       (2U)                          // Радуга вертикальная
#define EFF_RAINBOW_DIAG      (3U)                          // Радуга диагональная
#define EFF_COLORS            (4U)                          // Смена цвета
#define EFF_CLOUDS            (5U)                          // Облака
#define EFF_LAVA              (6U)                          // Лава
#define EFF_PLASMA            (7U)                          // Плазма
#define EFF_RAINBOW_STRIPE    (8U)                          // Павлин
#define EFF_ZEBRA             (9U)                          // Зебра
#define EFF_COLOR             (10U)                         // Цвет
#define EFF_SNOW              (11U)                         // Снегопад
#define EFF_SNOWSTORM         (12U)                         // Метель
#define EFF_MATRIX            (13U)                         // Матрица
#define EFF_LIGHTERS          (14U)                         // Светлячки
#define EFF_NOISE             (15U)                         // Шум
#define EFF_WHITE_COLOR       (16U)                         // Белый свет
#define MODE_AMOUNT           (17U)                         // количество режимов
